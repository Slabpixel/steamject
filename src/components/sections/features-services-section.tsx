...
export default function FeaturesServicesSection() {
  ...
  return (
    <section id="features" ref={sectionRef} className="relative bg-primary text-background overflow-hidden">
      <div className="relative max-w-8xl px-7.5 py-12 mx-auto w-full flex flex-col items-center gap-24 max-md:px-4 max-md:py-8 max-md:gap-12">
        <div className="flex w-full flex-col gap-8 max-md:gap-6">
          ...
          <div className="flex justify-between gap-4 max-md:flex-col max-md:gap-6">
            <div className="flex justify-between gap-2 w-full max-w-138 font-medium tracking-[-0.03em] text-[3.5rem] leading-[1.16] max-md:max-w-full max-md:text-[2.5rem]">
              <span data-reveal>01</span>
              <h2 data-reveal="split">Inject Feature</h2>
            </div>
            <div data-reveal className="max-w-82.5 max-md:max-w-full">
        ...
        <div className="grid grid-cols-2 grid-rows-2 w-full h-210 text-foreground max-md:grid-cols-1 max-md:grid-rows-none max-md:h-auto max-md:gap-4">
          <div data-reveal className="bg-background rounded-2xl border border-slate-300 p-10 flex gap-16 max-md:flex-col max-md:gap-6 max-md:p-6">
            ...
            <div className="flex flex-col justify-between max-md:gap-6">
              <div className="flex flex-col gap-6 max-md:gap-4">
                <h3 data-reveal="split" className="text-[2rem] font-medium leading-[1.16] tracking-[-0.03em] max-md:text-xl">Plasmid & BAC Injection</h3>
          ...
          <div data-reveal className="relative row-span-2 bg-background rounded-2xl border border-slate-300 p-10 flex gap-16 max-md:row-span-1 max-md:flex-col max-md:gap-6 max-md:p-6 max-sm:min-h-200 max-md:min-h-240">
            ...
            <div className="flex flex-col justify-between max-md:gap-6 max-md:relative max-md:z-1">
              <div className="flex flex-col gap-6 max-md:gap-4">
                <h3 data-reveal="split" className="text-[2rem] font-medium leading-[1.16] tracking-[-0.03em] max-md:text-xl">Embryo Transfer</h3>
          ...
          <div data-reveal className="bg-background rounded-2xl border border-slate-300 p-10 flex gap-16 max-md:flex-col max-md:gap-6 max-md:p-6">
            ...
            <div className="flex flex-col justify-between max-md:gap-6">
              <div className="flex flex-col gap-6 max-md:gap-4">
                <h3 data-reveal="split" className="text-[2rem] font-medium leading-[1.16] tracking-[-0.03em] max-md:text-xl">CRISPR/Cas9 Integration</h3>
