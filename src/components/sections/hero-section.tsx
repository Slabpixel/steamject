...
export default function HeroSection() {
  return (
    <section id="hero" className="relative min-h-170 h-[70vh] max-h-300 bg-primary overflow-hidden max-md:min-h-0 max-md:h-auto max-md:pb-10">
      ...
      <div className="absolute bottom-0 w-full h-1/2 z-2 max-md:h-2/5">
        <Image src="/hero-img-1.png" alt="Hero Image 1" width={1000} height={1000} className="absolute -bottom-120 -left-76 max-md:w-48 max-md:h-48 max-md:-bottom-20 max-md:-left-10" />
        <Image src="/hero-img-2.png" alt="Hero Image 2" width={1000} height={1000} className="absolute -bottom-60 -right-120 max-md:w-40 max-md:h-40 max-md:-bottom-10 max-md:-right-8" />
      ...
      <div className="relative max-w-8xl px-7.5 pt-37 mx-auto w-full flex flex-col items-center gap-22 max-md:px-4 max-md:pt-28 max-md:gap-10">
        <div className="relative max-md:flex max-md:flex-col max-md:items-center max-md:gap-4">
          <p className="absolute text-xs sm:text-sm md:text-base top-8 right-2 md:top-15.5 md:right-16 tracking-tight text-foreground/60 max-md:static max-md:text-center">
            © 2026 Steamject Corp. <br /> All Right Reserved
          </p>
          <h1 className="text-[6rem] md:text-[10rem] xl:text-[11.25rem] font-medium leading-[0.84] text-transparent bg-clip-text bg-linear-to-b from-foreground to-primary from-50% to-81% max-md:text-[3.25rem] max-md:text-center">
            DNA <br />
            Injection
          </h1>
        </div>
        <div className="flex max-md:flex-col items-stretch justify-stretch z-3 relative max-md:w-full max-md:gap-3">
          <div className="bg-background rounded-2xl p-3 border border-slate-300 flex gap-4 md:min-w-109 max-md:w-full">
            <Image src="/vid.png" alt="Video" width={114} height={114} className="rounded-lg overflow-hidden cursor-pointer max-md:size-20 max-md:shrink-0" />
