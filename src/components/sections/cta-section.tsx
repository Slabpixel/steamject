        ...
        <div className="grid grid-cols-2 w-full">
          <div className="pt-6 pr-6 gap-44 flex flex-col border border-slate-300">
            <div className="flex h-fit gap-4">
              ...
              <p className="uppercase text-xl leading-[1.16] font-medium">Information</p>
            </div>
          ...
          <div className="p-6 gap-44 flex flex-col border border-slate-300">
            <div className="flex h-fit gap-4">
              <Image src="/accent.svg" alt="Accent" width={16} height={16} />
              <p className="uppercase text-xl leading-[1.16] font-medium">{"Let's Build it Together"}</p>
            </div>
            <form className="flex flex-col w-full">
              <input type="name" name="name" id="name" className="block font-medium py-4 px-0 w-full text-xl text-foreground bg-transparent h-full border-0 appearance-none focus:outline-none focus:ring-0 border-b border-slate-100 focus:border-slate-300 max-h-14" placeholder="Name*" required />
              <textarea name="message" id="message" rows={4} className="block font-medium min-h-28 w-full resize-none border-0 border-b border-slate-100 bg-transparent px-0 py-4 text-xl text-foreground appearance-none focus:border-slate-300 focus:outline-none focus:ring-0" placeholder="Message*" required />
